...
.modal-message-box-left-noti {
    ...
    padding: 20px; /* 패딩을 줄여서 메시지가 더 잘 보이게 함 */
    font-size: 1.2em;
    margin-bottom: 20px;
}
...
<body class="LeftSideBar_body">
    ...
    <div id="leftSideModal" class="modal-left-noti">
        <div class="modal-content-left-noti">
            ...
            <h2 class="modal-title-left-noti">알림 내용</h2>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.message-box-left-noti').click(function() {
                ...
                $('#modalMessageLeft').text(message); // 메시지 설정
                $('#leftSideModal').show(); // 모달 표시
            });
            ...
            $('.close-left-noti, #close-left-noti').click(function() {
                ...
                $('#leftSideModal').hide();
                updateNotificationReadStatus(); // 읽음 상태 업데이트
            });
            ...
            function updateNotificationReadStatus() {
                ...
                $('#updateReadForm').submit(); // 읽음 상태 업데이트 폼 제출
            }

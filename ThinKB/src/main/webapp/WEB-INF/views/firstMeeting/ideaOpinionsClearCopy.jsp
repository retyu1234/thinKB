...
<body>
	...
	<div class="content-container">
		<h1>2차 의견 타이머 설정</h1>
			...
			<form action="./ideaOpinions2" id="ideaOpinions2" method="post">
...
<script>
document.getElementById('ideaOpinions2').addEventListener('submit', function(e) {
    e.preventDefault();
    ...
    if (timerHours === "" && timerMinutes === "" && timerSeconds === "") {
        ...
        var baseUrl = '/star/ideaOpinions2'; // 컨텍스트 경로에 맞게 수정하세요
